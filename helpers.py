...
from config import (
    ...
    ACTION_TIMEOUT_SECONDS, REQUIRED_CHANNELS
)
...
async def check_maintenance_middleware(handler, event, data):
    ...
    from aiogram import types
    from helpers import has_access  # ИСПРАВЛЕНО
